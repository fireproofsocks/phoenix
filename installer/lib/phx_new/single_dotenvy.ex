defmodule Phx.New.SingleDotenvy do
  @moduledoc false
  ...
  template(:new, [
    {
      :config,
      :project,
      "phx_single_dotenvy/config/config.exs": "config/config.exs",
      "phx_single_dotenvy/config/dev.exs": "config/dev.exs",
      "phx_single_dotenvy/config/prod.exs": "config/prod.exs",
      "phx_single_dotenvy/config/runtime.exs": "config/runtime.exs",
      "phx_single_dotenvy/config/test.exs": "config/test.exs"
      # "phx_single_dotenvy/envs/.env": "envs/.env",
      # "phx_single_dotenvy/envs/.dev.env": "envs/.dev.env",
      # "phx_single_dotenvy/envs/.test.env": "envs/.test.env",
      # "phx_single_dotenvy/envs/.prod.env": "envs/.prod.env"
    },
    {
      :eex,
      :project,
    ...
    {:eex, :web,
     "phx_single_dotenvy/lib/app_name/application.ex": "lib/:app/application.ex",
     "phx_single_dotenvy/lib/app_name.ex": "lib/:app.ex",
     ...
     "phx_single_dotenvy/lib/app_name_web.ex": "lib/:lib_web_name.ex",
     "phx_single_dotenvy/mix.exs": "mix.exs",
     "phx_single_dotenvy/README.md": "README.md",
     "phx_single_dotenvy/formatter.exs": ".formatter.exs",
     "phx_single_dotenvy/gitignore": ".gitignore",
     "phx_test/support/conn_case.ex": "test/support/conn_case.ex",
     "phx_single_dotenvy/test/test_helper.exs": "test/test_helper.exs",
